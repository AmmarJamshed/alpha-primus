  ...
  return (
    <section className="py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-[#A8C5A0]/20 via-white to-[#B8D4E8]/20 p-8 sm:p-12 lg:p-16">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <Button
              asChild
              size="lg"
              className="mt-8 rounded-full bg-[#0B1F3A] px-8 hover:bg-[#0B1F3A]/90"
            >
